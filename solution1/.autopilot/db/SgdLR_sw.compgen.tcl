...
set ID 9
set hasByteEnable 0
set MemName SgdLR_sw_gradient_V
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_V \
    op interface \
    ports { data_V_address0 { O 23 vector } data_V_ce0 { O 1 bit } data_V_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename label_V \
    op interface \
    ports { label_V_address0 { O 13 vector } label_V_ce0 { O 1 bit } label_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'label_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename theta_V \
    op interface \
    ports { theta_V_address0 { O 10 vector } theta_V_ce0 { O 1 bit } theta_V_q0 { I 32 vector } theta_V_address1 { O 10 vector } theta_V_ce1 { O 1 bit } theta_V_we1 { O 1 bit } theta_V_d1 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'theta_V'"
}
}
