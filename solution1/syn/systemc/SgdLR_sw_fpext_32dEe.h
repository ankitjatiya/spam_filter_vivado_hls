...
// ==============================================================
#ifndef __SgdLR_sw_fpext_32dEe__HH__
#define __SgdLR_sw_fpext_32dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(SgdLR_sw_fpext_32dEe) {
    ...
    SC_CTOR(SgdLR_sw_fpext_32dEe):  ACMP_fpext_U ("ACMP_fpext_U") {
